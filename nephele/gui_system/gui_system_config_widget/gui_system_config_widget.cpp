...
namespace talorion {
    ...
    gui_system_config_widget::gui_system_config_widget(QWidget *par) :
        ...
        current_entity(-1)
    {
        connect(event_manager::get_instance(),SIGNAL(newQuickScript(int)),this,SLOT(slot_newQuickScript(int)));
...
//        delete disconnect_button;
    ...
    void gui_system_config_widget::slot_add_button_clicked(bool)
    {
        ...
        entity_manager::get_instance()->createQuickScript(name,"");
    }
    ...
    void gui_system_config_widget::slot_itemClicked(QListWidgetItem *item)
    {
        ...
        quickscript_name_field->setText(entity_manager::get_instance()->get_name_component(current_entity));
        path_field->setText(entity_manager::get_instance()->get_user_data_path_component(current_entity));
...
//    }
    ...
    {
      Q_UNUSED(name);
      entity_manager::get_instance()->slot_change_userDataPath_component(current_entity, path_field->text());
    }

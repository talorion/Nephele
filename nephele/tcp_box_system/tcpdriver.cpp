  ...
  void tcpDriver::tcpError(QAbstractSocket::SocketError tcpErr)
  {
    ...
    switch (tcpErr) {
      ...
      case QAbstractSocket::RemoteHostClosedError:            {
          ...
          break;}
      case QAbstractSocket::HostNotFoundError:                {qDebug() <<"Box "<< getBox_id()<<": "<< "HostNotFoundError"; break;}
      ...
      case QAbstractSocket::NetworkError:                     {qDebug() <<"Box "<< getBox_id()<<": "<< "NetworkError"; break;}
      ...
      case QAbstractSocket::OperationError:                   {qDebug() <<"Box "<< getBox_id()<<": "<< "OperationError"; break;}

...
namespace talorion {
    ...
    public:
        ...
        const QMap<entity_manager::component_data_id_t, QVariant>& component_data_table() const{return m_component_data_table;}
        ...
        void add_component_to_entity(entity_manager::entity_id_t entity_id, entity_manager::component_id_t component_id,  entity_manager::component_data_id_t component_data_id);
    ...
    private:
        ...
        QMap<entity_manager::component_data_id_t, QVariant> m_component_data_table;           //component_data_id                  /// | [1..M columns, one column for each piece of data in your component]

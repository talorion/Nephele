...
namespace talorion {
    ...
    {
        connect(this,SIGNAL(newSystem(int)),event_manager_locator::get_instance(),SIGNAL(newSystem(int)));

        connect(this,SIGNAL(connection_state_component_changed(int)),event_manager_locator::get_instance(),SIGNAL(connection_state_component_changed(int)));

        connect(this, SIGNAL(user_data_path_changed(int)), event_manager_locator::get_instance(), SIGNAL(user_data_path_component_changed(int)));
        connect(this, SIGNAL(analogAct_component_changed(int)), event_manager_locator::get_instance(), SIGNAL(analogAct_component_changed(int)));
        connect(this, SIGNAL(analogSet_component_changed(int)), event_manager_locator::get_instance(), SIGNAL(analogSet_component_changed(int)));
        connect(this, SIGNAL(digitalAct_component_changed(int)), event_manager_locator::get_instance(), SIGNAL(digitalAct_component_changed(int)));
        connect(this, SIGNAL(digitalSet_component_changed(int)), event_manager_locator::get_instance(), SIGNAL(digitalSet_component_changed(int)));
        connect(this,SIGNAL(name_component_changed(int)),event_manager_locator::get_instance(),SIGNAL(name_component_changed(int)));
        connect(this,SIGNAL(script_file_component_changed(int)),event_manager_locator::get_instance(),SIGNAL(script_file_component_changed(int)));
        connect(this, SIGNAL(data_aquistion_dll_component_changed(int)),event_manager_locator::get_instance(),SIGNAL(data_aquistion_dll_component_changed(int)));
        connect(this, SIGNAL(timeout_component_changed(int)),event_manager_locator::get_instance(),SIGNAL(timeout_component_changed(int)));
        connect(this, SIGNAL(updaterate_component_changed(int)),event_manager_locator::get_instance(),SIGNAL(updaterate_component_changed(int)));
        ...
        connect(this, SIGNAL(newScriptableObject(int)),event_manager_locator::get_instance(),SIGNAL(newScriptableObject(int)));

        connect(event_manager_locator::get_instance(),SIGNAL(change_analogAct_component(int,double)),this,SLOT(slot_change_analogAct_component(int,double)),Qt::UniqueConnection);
        connect(event_manager_locator::get_instance(),SIGNAL(change_analogSet_component(int,double)),this,SLOT(slot_change_analogSet_component(int,double)),Qt::UniqueConnection);
        connect(event_manager_locator::get_instance(),SIGNAL(change_digitalAct_component(int,bool)),this,SLOT(slot_change_digitalAct_component(int,bool)),Qt::UniqueConnection);
        connect(event_manager_locator::get_instance(),SIGNAL(change_digitalSet_component(int,bool)),this,SLOT(slot_change_digitalSet_component(int,bool)),Qt::UniqueConnection);
        connect(event_manager_locator::get_instance(),SIGNAL(change_script_file_component(int,QString)),this,SLOT(slot_change_script_file_component(int,QString)));
        connect(event_manager_locator::get_instance(),SIGNAL(change_data_aquistition_dll_component(int,QString)),this,SLOT(slot_change_data_aquistion_dll_component(int,QString)));
        connect(event_manager_locator::get_instance(),SIGNAL(change_user_data_path_component(int,QString)),this,SLOT(slot_change_userDataPath_component(int,QString)));
        connect(event_manager_locator::get_instance(),SIGNAL(change_timeout_component(int,int)),this,SLOT(slot_change_timeout_component(int,int)));
        connect(event_manager_locator::get_instance(),SIGNAL(change_updaterate_component(int,int)),this,SLOT(slot_change_updaterate_component(int,int)));

        connect(this,SIGNAL(newAnalogInputValue(int)),event_manager_locator::get_instance(),SIGNAL(newAnalogInputValue(int)));
        connect(this,SIGNAL(newAnalogOutputValue(int)),event_manager_locator::get_instance(),SIGNAL(newAnalogOutputValue(int)));
        connect(this,SIGNAL(newAnalogValue(int)),event_manager_locator::get_instance(),SIGNAL(newAnalogValue(int)));
        connect(this,SIGNAL(newDigitalInputValue(int)),event_manager_locator::get_instance(),SIGNAL(newDigitalInputValue(int)));
        connect(this,SIGNAL(newDigitalOutputValue(int)),event_manager_locator::get_instance(),SIGNAL(newDigitalOutputValue(int)));
        connect(this,SIGNAL(newDigitalValue(int)),event_manager_locator::get_instance(),SIGNAL(newDigitalValue(int)));
        connect(this, SIGNAL(newTcpBox(int)),event_manager_locator::get_instance(),SIGNAL(newTcpBox(int)));
        connect(this, SIGNAL(newQtScriptEngine(int)),event_manager_locator::get_instance(),SIGNAL(newQtScriptEngine(int)));
        connect(this, SIGNAL(newTofDaqDll(int)),event_manager_locator::get_instance(),SIGNAL(newTofDaqDll(int)));
    }
...
//    }
    ...
    {
        return get_entity_by_component(SCRIPTABLE_OBJECT_COMPONENT);
    }

    QList<int> entity_manager::get_entities_with_userdata_components() const
    {
        return get_entity_by_component(USER_DATA_COMPONENT);
    }

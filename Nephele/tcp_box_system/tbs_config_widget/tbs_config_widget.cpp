...
namespace talorion {
    ...
    tbs_config_widget::tbs_config_widget(QWidget *par) :
        ...
        current_entity(-1)
    {
        connect(event_manager_locator::get_instance(),SIGNAL(newTcpBox(int)),this,SLOT(slot_newTcpBox(int)));
        connect(event_manager_locator::get_instance(),SIGNAL(connection_state_component_changed(int)),this,SLOT(slot_connection_state_changed(int)));
        connect(this,SIGNAL(connect_tcp_box(int)),event_manager_locator::get_instance(),SIGNAL(connect_tcp_box(int)));
        connect(this,SIGNAL(disconnect_tcp_box(int)),event_manager_locator::get_instance(),SIGNAL(disconnect_tcp_box(int)));
        connect(event_manager_locator::get_instance(),SIGNAL(name_component_changed(int)),this,SLOT(slot_name_component_changed(int)));
...
//        }
    ...
    {
        abstract_entity_manager*tmp=  entity_manager_locator::get_instance();
        tmp->createNewTcpBox();
    }
    ...
    void tbs_config_widget::slot_itemClicked(QListWidgetItem *item)
    {
        ...
        box_name_field->setText(entity_manager_locator::get_instance()->get_name_component(current_entity));
        ip_address_field->setText(entity_manager_locator::get_instance()->get_ip_address_component(current_entity));
        portField->setValue(entity_manager_locator::get_instance()->get_port_component(current_entity));
        backend_field->setValue(entity_manager_locator::get_instance()->get_tcp_box_backend_component(current_entity));

        bool tmp = entity_manager_locator::get_instance()->get_connection_state_component(current_entity);
    ...
    void tbs_config_widget::slot_connection_state_changed(int entity)
    {
        if(current_entity != entity)
            return;
        bool tmp = entity_manager_locator::get_instance()->get_connection_state_component(entity);
        update_visibility(tmp);
    }
    ...
    void tbs_config_widget::slot_name_component_changed(int entity)
    {
        if(current_entity != entity)
            return;
        QString tmp = entity_manager_locator::get_instance()->get_name_component(entity);
    ...
    void tbs_config_widget::slot_connect_button_clicked(bool)
    {
        ...
        if(current_entity>=0){
            entity_manager_locator::get_instance()->slot_change_name_component(current_entity, box_name_field->text());
            entity_manager_locator::get_instance()->slot_change_ip_address_component(current_entity, ip_address_field->text());
            entity_manager_locator::get_instance()->slot_change_port_component(current_entity, portField->value());
            entity_manager_locator::get_instance()->slot_change_tcp_box_backend_component(current_entity, backend_field->value());

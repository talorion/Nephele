...
//
        ...
        connect(this,SIGNAL(change_user_data_updaterate_component(int,int)),event_manager_locator::get_instance(),SIGNAL(change_updaterate_component(int,int)));
        connect(this,SIGNAL(change_user_data_path_component(int,QString)),event_manager_locator::get_instance(),SIGNAL(change_user_data_path_component(int,QString)));
...
//        timeout_field->setValue(to);
    ...
    void dad_config_widget::do_refresh_data()
    {
        ...
        int ur = entity_manager_locator::get_instance()->get_updaterate_component(current_entity);
        user_data_updaterate_field->setValue(ur);

        QString udp = entity_manager_locator::get_instance()->get_user_data_path_component(current_entity);

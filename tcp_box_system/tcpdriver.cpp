...
namespace talorion {
        ...
        m_back(bk)
    {
        ...
        connect(event_manager_locator::get_instance(),SIGNAL(send_custom_command(QString)),this,SLOT(customCommand(QString)));
        ...
        connect(this,SIGNAL(error(QString)),event_manager_locator::get_instance(),SIGNAL(error(QString)));
        connect(this,SIGNAL(receivedCustomData(QString)),event_manager_locator::get_instance(),SIGNAL(receivedCustomData(QString)));

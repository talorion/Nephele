...
void tcpDriver::disconect()
{
    ...
    if(serialSocket) tcpSocket->close();
...
void tcpDriver::tcpSocket_connected()
{
    ...
    //lastIP = entity_manager::get_instance()->get_ip_address_component(box_id);
}

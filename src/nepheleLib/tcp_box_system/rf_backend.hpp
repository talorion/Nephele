...
namespace talorion {
    ...
    private:
        virtual QString doGetName()const Q_DECL_OVERRIDE {return "UIBK ECMD RF Backend";}
        virtual backend_type doGetBackendType()const Q_DECL_OVERRIDE {return backend_type::UIBK_ECMD_RF;}

        virtual QByteArray doGetInfoCommand() const Q_DECL_OVERRIDE{return "uibk getAll";}
        virtual QByteArray doGetMinimalSetActCommand() const Q_DECL_OVERRIDE{return "uibk getAll";}

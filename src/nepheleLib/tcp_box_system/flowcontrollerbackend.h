...
namespace talorion {
    ...
    private:
        virtual QString doGetName()const Q_DECL_OVERRIDE {return "UIBK ECMD FC Backend";}
        virtual backend_type doGetBackendType()const Q_DECL_OVERRIDE {return backend_type::UIBK_ECMD_FC;}

        virtual QByteArray doGetInfoCommand() const Q_DECL_OVERRIDE {return "uibkafc getAll";}
        virtual QByteArray doGetMinimalSetActCommand() const Q_DECL_OVERRIDE {return "uibkafc getAll";}
    private:

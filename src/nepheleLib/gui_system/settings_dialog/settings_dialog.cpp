...
namespace talorion {
        ...
        list2entity()
    {
        ...
        settings_widget_label =  new TitleLabel("my fancy system");
        ...
        connect(EventManager::get_instance(),SIGNAL(newSystem(int)),this,SLOT(newSystem(int)));
    }
    ...
    void settings_dialog::slot_itemClicked(QListWidgetItem *item)
    {
        ...
        int entity = it.value();
        settings_widget = EntityManager::get_instance()->get_systemConfigurationWidget_component(entity);

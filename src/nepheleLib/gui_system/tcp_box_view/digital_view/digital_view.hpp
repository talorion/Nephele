...
namespace talorion{
    ...
    public:
      ...
      virtual int getLableWidth()const {return lblName->width();}
      virtual void setLabelMinimumWidth(int width) {lblName->setMidLineWidth(width);}
    ...
    public slots:
        ...
        virtual int updateLabelMinimumWidth(int width);

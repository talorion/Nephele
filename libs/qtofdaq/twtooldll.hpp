#ifndef TWTOOLDLL_HPP
#define TWTOOLDLL_HPP
...
namespace talorion{
    ...
    class TwToolDll : public QObject
    {
        Q_OBJECT
    public:
        explicit TwToolDll(QObject *par = 0);
        ~TwToolDll();
        Q_DISABLE_COPY(TwToolDll)
    ...
    template<typename T>
    T TwToolDll::resolve_method(const QString& method_name)
    {
